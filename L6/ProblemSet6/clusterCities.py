...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        # TO DO
        p1 = [p for p in c1.points]
        p2 = [p for p in c2.points]
        points = set(p1 + p2)
        c3 = Cluster(points, c1.pointType)
        ...
        for i in range(len(self.members)):
            for j in range(1, len(self.members)):
                if i != j:
                    ...
                    #print 'distance: %s - %s, %s' %(distance, c1, c2)
                    if res[0] is None or distance < res[0]:
                        res = (distance, (self.members[i], self.members[j]))
                        #print 'res = ', res
        return res[1]
    ...
    def mergeOne(self, linkage):
        ...
        self.mergeClusters(res[0], res[1])
        return res
